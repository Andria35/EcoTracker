...
final class AirQualityDetailsViewModel {
    ...
    func getAirQualityDescription(forAQI aqius: Int) -> String {
        return airQualityDescription(forAQI: aqius)
    }
    
    private func airQualityDescription(forAQI aqius: Int) -> String {
